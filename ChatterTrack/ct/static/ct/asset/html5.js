    ...
    ajaxFunctions : {
        ...
        handleTweetsWithWord : function (name,category,word) {
            ...
            return function (data) {
                ...
                var htmlString = "<h3>" + name + "&rsquo;s followers&rsquo; tweets about " + category + ", " + word + "</h3>"; 
        ...
        updateGraph : function (data) {
            ...
            a = data.results.categories.business;
            b = data.results.categories.sports;
            c = data.results.categories.food;
            d = data.results.categories.politics;
            e = data.results.categories.entertainment;
            f = data.results.categories["science-technology"];
            g = data.results.categories["healthy-living"];
            h = data.results.categories["education"];
            i = data.results.categories["religion"];
            ...
            chart.addSeries({
                ...
                data: [ap, bp, cp, dp, ep, fp, gp, hp, ip] 
            });
...
$(document).ready( function () {
    ...
    ChatterTrack.createHighChart2($('#word-count-container'));
